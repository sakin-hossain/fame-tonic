...
const HeroSection = () => {
    return (
        <div className="flex flex-col-reverse lg:flex-row md:flex-col-reverse px-5 sm:p-0">
            <div className="lg:ml-215 lg:mt-57 lg:mb-30 md:mx-auto max-w-516 z-20">
                <div className="mb-22 sm:mb-4">
                    <h1 className="font-urbanist font-extrabold sm:font-bold text-25 lg:text-35 md:text-25px leading-[100%] w-328 sm:w-full mx-auto tracking-normal align-middle text-center sm:text-left h-60 sm:h-84">
                        Want to Turn Social Media Into a Profitable Career?{" "}
                    </h1>
                    <h1 className="font-urbanist font-extrabold sm:font-bold text-25 lg:text-35 md:text-25 leading-[100%] w-328 sm:w-full mx-auto tracking-normal align-middle text-center sm:text-left text-shadow-red-glow text-primary h-60 sm:h-84">
            ...
            <div className="static mt-2.5 lg:mt-0 md:mt-7 sm:mt-2.5 md:mx-auto lg:absolute md:static right-139 top-121 z-10">
                <Image
                    src={HeroImage}
                    width={666}
                    height={679}
